...
export class Payment {
  ...
  get processedById() {
    return this.props.processedById
  }
  get createdAt() {
  ...
  get isSuccessful() {
    return this.props.paymentStatus === 'SUCCESS'
  }
  ...
  get isFailed() {
    return this.props.paymentStatus === 'FAILED'
  }
  get isFullyRefunded() {
    return this.props.paymentStatus === 'REFUNDED'
  }
  get isPartiallyRefunded() {
    return this.props.paymentStatus === 'PARTIALLY_REFUNDED'
  }
  get isCancelled() {
    return this.props.paymentStatus === 'CANCELLED'
  }
  ...
  get canBeCancelled() {
    return this.props.paymentStatus === 'PENDING' || this.props.paymentStatus === 'AUTHORIZED'
  }
