...
export default function GuestPortal() {
  ...
  const upsellOffers = [
    {
      id: 'up_1',
      title: 'Early Check-in (Instant Access)',
      desc: 'Skip the 3:00 PM wait. Walk straight into your clean room now.',
      price: 29.0,
      type: 'EARLY_CHECKIN',
      icon: Clock,
    },
    {
      id: 'up_2',
      title: 'Executive Deluxe Upgrade',
      desc: 'Upgrade to high-floor deluxe with premium city skyline vistas.',
      price: 45.0,
      type: 'ROOM_UPGRADE',
      icon: Sparkles,
    },
    {
      id: 'up_3',
      title: 'Artisan Breakfast Basket',
      desc: 'Fresh sourdough, pastries, local fruits and cold-brew delivered to door.',
      price: 18.0,
      type: 'AMENITY',
      icon: Coffee,
    },
  ...
  const foodCatalog = [
    {
      id: 'f_1',
      name: 'Premium Club Sandwich & Fries',
      desc: 'Smoked turkey, avocado, cheddar, house dynamic spread',
      price: 16.5,
    },
    {
      id: 'f_2',
      name: 'Tuscan Caesar Salad',
      desc: 'Crisp romaine, shaved parmesan, garlic focaccia crisps',
      price: 14.0,
    },
    {
      id: 'f_3',
      name: 'Single-Origin Cold Brew Coffee',
      desc: 'House blend, slow-steeped over 18 hours',
      price: 5.5,
    },
  ]
    ...
    async function loadPortalData() {
      try {
        ...
        if (resolved) {
          ...
          setError(
            'This MagicLink is invalid or has expired. Please verify your token or contact the hotel front desk.',
          )
        }
      } catch (err: any) {
  ...
  useEffect(() => {
    const handleAICmd = (e: any) => {
      ...
      if (action === 'upgrade_room') {
        ...
        alert(
          'Contactless checkout completed! Room key deactivated and invoice paid via card on file.',
        )
      }
    }
  ...
  // Folio Calculation
  const roomBaseTotal =
    booking?.rooms?.reduce((acc: number, r: any) => acc + Number(r.totalRoomAmount || 0), 0) || 0
    ...
    return (
      ...
      >
        ...
        <p style={{ color: '#9ca3af', fontSize: '15px' }}>
          Retrieving secure contactless portal...
        </p>
        <style>{`
    ...
    return (
      <div style={{ maxWidth: '480px', margin: '80px auto', padding: '24px', textAlign: 'center' }}>
        ...
        >
          ...
          <h2 style={{ fontSize: '20px', fontWeight: 600, color: '#f3f4f6', marginBottom: '8px' }}>
            Security Lockout
          </h2>
          <p style={{ color: '#9ca3af', fontSize: '14px', lineHeight: '20px' }}>
  ...
  return (
    <div
      style={{ maxWidth: '640px', margin: '0 auto', padding: '16px 16px 80px', minHeight: '100vh' }}
    >
      {/* Dynamic Toast Alert */}
      {showOrderToast && (
        <div
          style={{
            ...
            padding: '12px 20px',
            borderRadius: '30px',
            boxShadow: '0 8px 30px rgba(0, 242, 254, 0.25)',
            display: 'flex',
            alignItems: 'center',
            gap: '8px',
            zIndex: 1000,
      ...
      <div
        style={{
          background: 'linear-gradient(135deg, rgba(16, 22, 42, 0.8), rgba(6, 9, 19, 0.8))',
      ...
      >
        <div>
          ...
          <h1 style={{ fontSize: '20px', fontWeight: 700, color: '#f3f4f6', marginTop: '2px' }}>
            {guestName}
          </h1>
          <span
            style={{
        ...
        <div
          style={{
            background: checkInCompleted ? 'rgba(16, 185, 129, 0.15)' : 'rgba(245, 158, 11, 0.15)',
            border: checkInCompleted
              ? '1px solid rgba(16, 185, 129, 0.3)'
              : '1px solid rgba(245, 158, 11, 0.3)',
            color: checkInCompleted ? '#10b981' : '#f59e0b',
            fontSize: '11px',
            padding: '4px 10px',
            borderRadius: '20px',
            fontWeight: 600,
      ...
      {!checkInCompleted ? (
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
            <div
              style={{ background: 'rgba(0, 242, 254, 0.15)', padding: '6px', borderRadius: '8px' }}
            >
              <Key size={18} color="#00f2fe" />
            </div>
            <h2 style={{ fontSize: '16px', fontWeight: 600, color: '#f3f4f6' }}>
              Contactless Check-In Wizard
            </h2>
          </div>
          ...
          <div style={{ display: 'flex', gap: '8px', marginBottom: '20px' }}>
            <div
              style={{
                ...
                height: '4px',
                borderRadius: '2px',
                background: checkInStep >= 1 ? '#00f2fe' : 'rgba(255, 255, 255, 0.1)',
              }}
            />
            <div
              style={{
                ...
                height: '4px',
                borderRadius: '2px',
                background: checkInStep >= 2 ? '#00f2fe' : 'rgba(255, 255, 255, 0.1)',
              }}
            />
            <div
              style={{
                ...
                height: '4px',
                borderRadius: '2px',
                background: checkInStep >= 3 ? '#00f2fe' : 'rgba(255, 255, 255, 0.1)',
              }}
            />
          </div>
              ...
              >
                ...
                <div>
                  ...
                  <input
                    type="text"
                    readOnly
                    value={booking.guests?.[0]?.email || 'contact@stayflexi.com'}
                    style={{
                      width: '100%',
                      padding: '10px 14px',
                      background: 'rgba(0,0,0,0.2)',
          ...
          {checkInStep === 2 && (
            <div>
              ...
              >
                Stayflexi relies on automated document verification. Scan or upload your government
                ID.
              </p>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    background: idPhoto ? 'rgba(0, 242, 254, 0.03)' : 'rgba(0,0,0,0.1)',
                    padding: '24px 16px',
                    borderRadius: '12px',
                    textAlign: 'center',
                    cursor: 'pointer',
                    transition: 'all 0.2s ease',
                    borderColor: idPhoto ? '#00f2fe' : 'rgba(255,255,255,0.08)',
                  }}
                >
                  {idPhoto ? (
                    <div
                    ...
                    >
                      ...
                      <span style={{ fontSize: '13px', color: '#f3f4f6', fontWeight: 600 }}>
                        Government ID Verified!
                      </span>
                      <span style={{ fontSize: '11px', color: '#9ca3af' }}>
                        Click to scan again ({idNumber || 'OCR Active'})
                      </span>
                    </div>
                  ) : (
                    <div
                    ...
                    >
                      ...
                      <span style={{ fontSize: '13px', color: '#f3f4f6', fontWeight: 500 }}>
                        Tap to Scan Passport / ID
                      </span>
                      <span style={{ fontSize: '11px', color: '#9ca3af' }}>
                        Uses secure instant mobile scanner tool
                      </span>
                    </div>
                  )}
                </div>
          ...
          {checkInStep === 3 && (
            <div>
              ...
              >
                Draw your digital signature inside the glassmorphic canvas below to complete the
                registration card contract.
              </p>
        ...
        >
          ...
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#f3f4f6', marginBottom: '4px' }}>
            Smart IoT Key Reveal
          </h2>
          <p style={{ color: '#9ca3af', fontSize: '13px', marginBottom: '16px' }}>
            Your self check-in and folio balances are verified. Access is granted.
          </p>
          ...
          >
            ...
            >
              {smartKey?.accessCode || 'GENERATING...'}
            </span>
            <span style={{ fontSize: '10px', color: '#9ca3af', marginTop: '8px' }}>
              Press '*' followed by keycode at door lock.
            </span>
          </div>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
          ...
          <h2 style={{ fontSize: '15px', fontWeight: 600, color: '#f3f4f6' }}>
            Stayflexi Dynamic Folio Upsells
          </h2>
        </div>
              ...
              >
                ...
                >
                  <div
                    style={{
                      ...
                      padding: '8px',
                      borderRadius: '8px',
                      color: isPurchased ? '#10b981' : '#00f2fe',
                    }}
                  >
                    <Icon size={18} />
                  </div>
                  <div>
                    <h3 style={{ fontSize: '13px', fontWeight: 600, color: '#f3f4f6' }}>
                      {offer.title}
                    </h3>
                    <p
                      style={{
                ...
                <div>
                  {isPurchased ? (
                    ...
                    <button
                      onClick={() => purchaseUpsellOffer(offer)}
                      style={{
                        padding: '6px 12px',
                        background: 'rgba(0, 242, 254, 0.1)',
                        border: '1px solid rgba(0, 242, 254, 0.2)',
