...
Save your result to graphify-out/.graphify_chunk_{i+1:02d}.json
"""
    Path(f'graphify-out/prompt_{i+1:02d}.txt').write_text(prompt, encoding='utf-8')
